#
# Be sure to run `pod lib lint DDLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'DDLibrary'
  s.version          = '0.1.0'
  s.summary          = 'A short description of DDLibrary.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'DDLibrary/Classes/**/*'
  
  # s.resource_bundles = {
  #   'DDLibrary' => ['DDLibrary/Assets/*.png']
  # }
